...
const ROLE_PERMISSIONS: Record<AppRole, string[]> = {
  superadmin_rrhh: [
    ...
    "settings.view", "settings.users", "settings.departments", "settings.smtp", "settings.params", "settings.audit", "settings.backup", "settings.profiles",
  ],
  admin_rrhh: [
    "dashboard.view",
    ...
    "assets.view", "assets.manage",
    "reports.view", "reports.export",
    "settings.view", "settings.users", "settings.departments", "settings.smtp", "settings.params",
  ],
  jefe_area: [
    "dashboard.view",
    "employees.view",
  ...
  const hasTargetPermission = useCallback(
    (permission: string) => {
      ...
      if (fromTarget !== undefined) {
        return fromTarget.includes(permission) || roleDefaults.includes(permission);
      }
      return roleDefaults.includes(permission);
    },
    [user, hasPermission],
